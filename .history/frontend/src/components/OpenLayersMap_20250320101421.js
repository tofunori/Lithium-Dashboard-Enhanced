...
const calculatePointSize = (production) => {
  // Échelle logarithmique pour mieux représenter les grandes différences
  // Tailles beaucoup plus contrastées pour une meilleure visibilité
  if (production < 100) return 5;
  if (production < 1000) return 8;
  if (production < 10000) return 12;
  if (production < 100000) return 18;
  if (production < 1000000) return 24;
  return 32; // Taille maximale beaucoup plus grande
};
