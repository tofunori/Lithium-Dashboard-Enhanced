...
const calculatePointSize = (production) => {
  // Échelle avec des différences beaucoup plus marquées
  if (production < 100) return 7;
  if (production < 1000) return 12;
  if (production < 10000) return 18;
  if (production < 100000) return 25;
  if (production < 1000000) return 35;
  return 45; // Taille maximale très grande
};
