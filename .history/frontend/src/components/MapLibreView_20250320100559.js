  ...
  useEffect(() => {
    ...
    try {
      ...
      const map = new maplibregl.Map({
        ...
        boxZoom: false, // Désactiver pour améliorer les performances
        fadeDuration: 0, // Pas de transition pour plus de fluidité
        optimizeForTerrain: false,
        preserveDrawingBuffer: false,
        refreshExpiredTiles: false,
        maxPitch: 0, // Pas d'inclinaison
        touchZoomRotate: false, // Pas de rotation
