...
const UploadDocument = ({ onUploadSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Fichier téléversé avec succès!', snapshot);
      
      // Obtenir l'URL de téléchargement
      const downloadURL = await getDownloadURL(storageRef);
      
      // Créer les données du document avec l'URL Firebase
      ...
      const addedDocument = addDocument(documentWithURL, selectedFile, downloadURL);
