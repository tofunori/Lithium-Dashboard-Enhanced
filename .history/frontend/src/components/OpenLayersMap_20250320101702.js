...
const calculatePointSize = (production) => {
  // Utiliser une échelle logarithmique pour mieux représenter les grandes différences
  // Minimum: 6 pour très petite production
  // Maximum: 32 pour très grande production
  if (production < 100) return 6;
  if (production < 1000) return 10;
  if (production < 10000) return 15;
  if (production < 100000) return 20;
  if (production < 1000000) return 25;
  return 32;
};
