...
export const AuthProvider = ({ children }) => {
  ...
  const logout = async () => {
    try {
      // D'abord, mettre à jour l'état local pour éviter des appels avec une session invalide
      setCurrentUser(null);
      setUserId(null);
      setIsAuthenticated(false);
      setAuthError(null);
      ...
      // Ne pas propager cette erreur pour assurer que l'utilisateur est toujours déconnecté côté client
      return true;
    }
  };
