...
export const DocumentsProvider = ({ children }) => {
  ...
  const removeDocument = async (documentId, foundryId, firebaseFilePath) => {
    ...
    // Trouver d'abord le document pour récupérer son chemin Firebase si nécessaire
    ...
    // Si le document a un chemin Firebase, l'utiliser pour la suppression
    if (docToRemove && docToRemove.firebasePath) {
      firebaseFilePath = docToRemove.firebasePath;
    }
